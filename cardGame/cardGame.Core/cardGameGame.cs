...
using cardGame.Core.Localization;
using cardGame.Core.Settings;
using cardGame.ScreenManagers;
...
namespace cardGame.Core
{
    ...
    /// </remarks>}
    public class cardGameGame : Game
    {
        ...
        private SettingsManager<cardGameSettings> settingsManager;

        // Manages leaderboard data for tracking high scores and achievements.
        private SettingsManager<cardGameLeaderboard> leaderboardManager;
        ...
        public cardGameGame()
        {
            ...
            settingsManager = new SettingsManager<cardGameSettings>(storage);
            Services.AddService(typeof(SettingsManager<cardGameSettings>), settingsManager);

            leaderboardManager = new SettingsManager<cardGameLeaderboard>(storage);
            Services.AddService(typeof(SettingsManager<cardGameLeaderboard>), leaderboardManager);
